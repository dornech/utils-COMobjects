...
Welcome to the contributor guide of COM utilities for Python.
...
If you experience bugs or general issues with COM utilities for Python, please have a look
...
You can help improve the documentation of COM utilities for Python by making them more readable
...
3. Clone this copy to your local disk:
   ...
   ```console
   git clone git@github.com:YourLogin/utils-COMobjects.git
   cd utils-COMobjects
   ```
